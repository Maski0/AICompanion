...
export declare class CubismExpressionMotion extends ACubismMotion {
     ...
     */
    calculateExpressionParameters(model: CubismModel, userTimeSeconds: number, motionQueueEntry: CubismMotionQueueEntry, expressionParameterValues: csmVector<ExpressionParameterValue>, expressionIndex: number): void;
    /**
     ...
     * @returns 計算結果
     */
    calculateValue(source: number, destination: number): number;
    /**
     * コンストラクタ
     */
